...
numTimeSteps = {}
vel_maxL2Norm = vel_maxH1Norm = {}
vel_ell2L2Norm = vel_ell2H1Norm = {}
...
for i in range(num_filenames):
    ...
    vel_ell2L2Norm[i] = vel_ell2H1Norm[i] = 0
...
if num_filenames > 1:
    ...
    rate_vel_maxL2Norm = rate_vel_maxH1Norm = [0]*num_filenames
    rate_vel_ell2L2Norm = rate_vel_ell2H1Norm = [0]*num_filenames
    ...
    print "numTS\tvel_maxL2  rate    vel_maxH1  rate"
    for i in range(num_filenames):
